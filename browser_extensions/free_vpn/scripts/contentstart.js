...
if ((localStorage.server !== false && localStorage.server !== "false")  && (window.location.hostname != "freevpn.one" && window.location.hostname != "www.freevpn.one")) {
